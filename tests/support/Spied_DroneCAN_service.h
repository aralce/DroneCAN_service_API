...
// public:
//     explicit Spied_droneCAN_service(uint8_t node_ID = DEFAULT_NODE_ID, droneCAN_handle_error_t handle_error = handle_error_dummy)
//         : DroneCAN_service(node_ID, handle_error), _handle_error(handle_error) {}
...
// private:
//     DroneCAN_error _handle_error;
//     static void handle_error_dummy(DroneCAN_error error) {}
// };